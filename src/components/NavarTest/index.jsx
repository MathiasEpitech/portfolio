...
const NavBarTest = () => {
  ...
  return (
    <header>
      ...
      <nav ref={navRef}>
        <NavLink exact activeClassName="active" className="nav-link" to="/" data-text="HOME">
          <FontAwesomeIcon icon={faHome} color="#000000" />
        </NavLink>
        <NavLink exact activeClassName="active" className="nav-link" to="/about" data-text="ABOUT">
          <FontAwesomeIcon icon={faUser} color="#000000" />
        </NavLink>
        <NavLink exact activeClassName="active" className="nav-link" to="/project" data-text="PROJECT">
          <FontAwesomeIcon icon={faRectangleList} color="#000000" />
        </NavLink>
        <NavLink exact activeClassName="active" className="nav-link" to="/#contact" data-text="CONTACT">
